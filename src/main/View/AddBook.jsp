		...
		<form class="row" action="AddBook" method="post" enctype="multipart/form-data">
			<div class="col-md-7">
				<div class="form-group">
				    ...
				    <input type="text" class="form-control" id="book-name" name="name" placeholder="Nhập tên sách" required>
				</div>
				<div class="form-group">
				    <label for="book-author">Tác Giả:</label>
				    <input type="text" class="form-control" id="book-author" name="author" placeholder="Nhập tên tác giả" required>
				</div>
				<div class="form-group">
				    <label for="book-price">Giá Bán:</label>
				    <input type="number" class="form-control" id="book-price" name="price" value="20000" min="0" required>
				</div>
				<div class="form-group">
				    <label for="book-amount">Số Lượng:</label>
				    <input type="number" class="form-control" id="book-amount" name="amount" value="1" min="0" required>
				</div>
				<div class="form-group">
			...
			<div class="col-md-5">
				<div class="form-group">
				    <label for="book-image">Chọn Ảnh Bìa:</label>
				    <input type="file" 
				    	class="form-control" 
				    	id="book-image" 
				    	name="image" 
				...
				<div class="p-2">
					<img id="preview-image" src="#" height="200" alt="Bìa Sách" class="border">
                </div>
			</div>
			<div class="col-md-12 d-flex justify-content-end">
				<a class="btn btn-danger mr-3" href="BooksManage" role="button">Hủy Bỏ</a>
				<input type="submit" class="btn btn-warning" name="submit" value="Thêm Sách">
			</div>
		</form>
	</div>
</body>
